...
export const pagination = {
    ...
    reducers:{
        update_current_page:(state:paginationStateFace,payload:string)=>({...state, current_page: payload}),
        update_total_pages:(state:paginationStateFace, payload:string)=>({...state, total_pages: payload}),
